...
<title>NICE-A |Brute Force Attack</title>
<!-- Bootstrap -->
<link rel="stylesheet"
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h2 class="panel-title">Brute Force Attack</h2>
						</div>
						<div class="well">
							...
							<form class="form-horizontal" id="userLogin" name="userLogin"
								...
								<input type="hidden" name="clientIp"  value="<%=request.getRemoteHost()%>">
                                  ...
                                  Brute Force Attack aims at being the simplest kind of method to gain access to a site:
                                    it tries enterd  usernames and passwords is wrong .
