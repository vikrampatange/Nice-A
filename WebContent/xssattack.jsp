			...
			<div class="navbar navbar-default">
				...
				<div class="navbar-collapse collapse navbar-responsive-collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="<%=request.getContextPath()%>/sqlinjection.jsp">Sql Injection </a></li>
						
					<!-- <li class="active"><a href="<%=request.getContextPath()%>/xssattack.jsp">XSS Attack </a></li> -->
				...
				<div class="col-lg-12">
					...
					<%
						if (request.getParameter("message") != null
								...
								&& request.getParameter("message").equals("normal")!=true ) {
					%>
					...
					%>
						...
						if (request.getParameter("message") != null
								&& request.getParameter("message") != ""
								&& request.getParameter("message").equals("normal") ) {
					%>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h2 class="panel-title">User Login-Xss Attack Demonstration</h2>
						</div>
						<div class="well">

							<form class="form-horizontal" id="userLogin" name="userLogin"
								action="XssAttack" method="get">
