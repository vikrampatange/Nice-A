...
<title>NICE-A |SQL Injection </title>
<!-- Bootstrap -->
<link rel="stylesheet"
			...
			<div class="navbar navbar-default">
				...
				<div class="navbar-collapse collapse navbar-responsive-collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="<%=request.getContextPath()%>/sqlinjection.jsp">Attack </a></li>
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h2 class="panel-title">User Login-SQL Attack Demonstration</h2>
						</div>
						<div class="well">
						

							<form class="form-horizontal" id="sqlInjection" name="sqlInjection" action="SqlInjection" method="post">

								<input type="hidden" name="action" value="sqlInjection" >
								
								<input  type="hidden" name="clientIp" value="<%=request.getRemoteHost()%>">
								 
                                <pre class="prettyprint linenums"> Ex.  select * FROM users WHERE name = '' or '1'='1'; </pre>
                                 <pre class="prettyprint linenums">&lt;script&gt;alert('xss Vulnerable')&lt;/script&gt; </pre>
								...
								<div class="form-group">
									...
									<label for="vm" class="control-label col-xs-4"> Virtual Machine:</label>
