...
<table class="formular">
	...
	<input type="hidden" name="sort" value="<%=request.getParameter("sort")%>">
		...
		<input type="Submit" name="Submit" value="Save" class="btn btn-info"></td>
	</form>
...
%>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a  href="login.jsp" class="btn btn-primary btn-sm">Logout </a> 
    <br /><br />
    
	<table id="filetable" class="filelist table table-bordered " cellspacing="1px" cellpadding="0px"  >
<%
			...
			for (int i = 0; i < entry.length; i++) {
				boolean forbidden = true;  // change show only particular drive 
	...
	<p align=center>
		...
		<input title="Download selected files and directories as one zip file" class="btn btn-success" id="but_Zip" type="Submit" name="Submit" value="<%=SAVE_AS_ZIP%>">
		 
		
		<% if (!READ_ONLY) {%>
			<input title="Delete all selected files and directories incl. subdirs" class="btn btn-danger"  id="but_Del" type="Submit" name="Submit" value="<%=DELETE_FILES%>"
